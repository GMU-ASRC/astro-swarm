...
static func _level_one() -> Array:
	return [
		...
		{"id": 7, "text": "When the layout looks right, press launch and watch it play out. Then submit the algorithm and my machines will run it a hundred times over on the server. Good luck, Commander."},
	]
...
static func _level_two() -> Array:
	return [
		...
		{"id": 7, "text": "The best entry submitted here becomes the opponent in level three, layout and all. Beat everyone and other commanders will be flying against your work."},
	]
